...
public class HerencaTest02 {
    ...
    // 4 - Bloco de inicialização da superclasse é executada na ordem em que aparece
    // 5 - Construtor é executado da superclasse
    // 6 - Alocado espaço em memória pro objeto subclasse
    ...
    public static void main(String[] args) {
        Funcionario funcionario = new Funcionario("Double");
    }
}
